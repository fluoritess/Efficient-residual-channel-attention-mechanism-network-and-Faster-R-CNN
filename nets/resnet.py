...
from .erca_module import eca_layer,ERCALayer,ERCAMA_Layer
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None,k_size=3):
        ...
        self.erca = ERCALayer(planes * 4, k_size)
...
class RE34BasicBlock(nn.Module):
    expansion = 1

    def __init__(self, inplanes, planes, stride=1, downsample=None, k_size=3):
        super(RE34BasicBlock, self).__init__()
        self.conv1 = conv3x3(inplanes, planes, stride)
        self.bn1 = nn.BatchNorm2d(planes)
        self.relu = nn.ReLU(inplace=True)
        self.conv2 = conv3x3(planes, planes, 1)
        self.bn2 = nn.BatchNorm2d(planes)
        self.erca = ERCALayer(planes, k_size)
        self.downsample = downsample
        self.stride = stride
...
def resnet101():
    model = ResNet(Bottleneck, [3, 4, 23,
                                3])
    features = list([model.conv1, model.bn1, model.relu, model.maxpool, model.layer1, model.layer2, model.layer3])
    classifier = list([model.layer4, model.avgpool])
...
def resnet152():
    model = ResNet(Bottleneck, [3, 8, 36,
                                3])
    features = list([model.conv1, model.bn1, model.relu, model.maxpool, model.layer1, model.layer2, model.layer3])
...
def resnet34():
    model = ResNet2(RE34BasicBlock, [3, 4, 6, 3])
